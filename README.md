...
- 🍽️ Manage restaurant menu: add, edit, delete dishes
...
- 🔗 *HTTP Client:* Axios
- 🗄️ *Backend (Fake):* JSON Server (db.json)
...
### 📅 Reservation
![Reservation](public/images/reservation.png)
...
- 💼 LinkedIn: [Marwa Hilali](https://www.linkedin.com/in/marwa-hilati)
